#!/bin/bash
# Parallel OVO full eval across 8 GPUs
# Splits tasks to minimize total wall-clock time.
...
# Task assignments (sample counts in comments)
# EPM:297  ASI:148  HLD:186  OCR:149  ACR:109  ATR:116
# STU:178  FPD:101  OJR:184  REC:82   SSR:42   CRR:48
TASKS_GPU0="EPM"
TASKS_GPU1="HLD,ASI"
TASKS_GPU2="OCR,ACR"
...
OUT_BASE="${CKPT}/eval/ovo_full_parallel_${FRAME_PROTOCOL}"
mkdir -p "$OUT_BASE"
