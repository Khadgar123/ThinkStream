...
BATCH_ROOT="${PROJECT_ROOT}/data/agent_v5/batch1"
...
export THINKSTREAM_BATCH="batch1"
...
VIDEOS_JSONL="${VIDEOS_JSONL:-${PROJECT_ROOT}/data/agent_v5/batch1/selected_videos.jsonl}"
...
expected = Path("/home/tione/notebook/gaozhenkun/hzh/ThinkStream/data/agent_v5/batch1")
