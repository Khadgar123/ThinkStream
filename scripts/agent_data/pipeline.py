...
async def run_pipeline(
    ...
    if not os.environ.get("SKIP_PASS45"):
        ...
        pass5_ok = True
        try:
            from scripts.agent_data import pass5_messages as _pass5_mod
        ...
        # Opt-in via env THINKSTREAM_RUN_PASS5_TRAJECTORY=1 (legacy alias
        # THINKSTREAM_RUN_PASS5_V2 still accepted). Independent of legacy
        # pass5_messages; reads the same FINAL_DIR trajectory JSONL files
        # and emits Qwen-native messages+tools format to rendered/trajectory/.
        _run_trajectory = (
            os.environ.get("THINKSTREAM_RUN_PASS5_TRAJECTORY", "0") == "1"
            or os.environ.get("THINKSTREAM_RUN_PASS5_V2", "0") == "1"
        )
        if pass4_ok and _run_trajectory:
            ...
            try:
                ...
                logger.error(
                    "pass5 trajectory failed: %s; legacy pass5 output remains usable",
                    e,
                )
