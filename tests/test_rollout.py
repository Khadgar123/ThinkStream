...
- compute_mixed_advantage alpha-mixing of outcome + state advantages
...
# =============================================================================
# compute_mixed_advantage — alpha-mixed outcome + state
# =============================================================================
...
def test_default_update_state_final_answer():
...
def test_default_update_state_recall_call():
...
def test_chunklevel_rollout_loop_mock_terminates_on_answer():
    ...
    loop = ChunkLevelRolloutLoop(
        cfg, mock_generate, mock_build_messages, default_update_state,
    )
    initial = _make_state()
...
def test_chunklevel_rollout_loop_max_chunks_terminates():
    ...
    loop = ChunkLevelRolloutLoop(
        cfg, mock_silent_generate, mock_build_messages, default_update_state,
    )
    result = loop.rollout_one_video(
...
def main():
    tests = [
        ...
        test_default_update_state_silent_answer,
        test_default_update_state_final_answer,
        test_default_update_state_recall_call,
        test_default_update_state_compress_call,
