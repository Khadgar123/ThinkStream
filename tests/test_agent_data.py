...
class TestMemoryState:
    ...
    def test_compress_threshold_token_based(self):
        from scripts.agent_data.config import COMPRESS_TOKEN_THRESHOLD
        mem = MemoryState()
...
class TestCompressionRangeSelection:
    ...
    def test_optimal_range_picks_least_important(self):
        from scripts.agent_data.pass2_rollout import choose_optimal_compress_range
        timeline = [
    ...
    def test_optimal_range_respects_size_bounds(self):
        from scripts.agent_data.pass2_rollout import choose_optimal_compress_range
        from scripts.agent_data.config import COMPRESS_RANGE_MIN, COMPRESS_RANGE_MAX
...
class TestCompressedSourceTexts:
    def test_selected_range_only(self):
        from scripts.agent_data.pass3e_verify import _compressed_source_texts
        sample = {
            "sample_type": "compress",
            "input": {
                "memory": {
